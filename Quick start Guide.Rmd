...
Supose that you have downloaded a .xlsx file from your bank website containing your incomes and expenses of the current year ([click here](https://www.kaggle.com/notis23/bank-movements-with-descriptions-in-spanish#example_bank_movements.xlsx) to download a simulated .xlsx file that we will use during the start guide. Please, take now 15 sec. to see the content of the file).   
